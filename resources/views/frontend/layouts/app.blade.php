    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link nav-link-1 {{ request()->routeIs('index')? 'active':''  }}" aria-current="page" href="{{route('index')}}">Photos</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link nav-link-1 {{ request()->routeIs('photo-detail')? 'active':''  }}" aria-current="page" href="{{route('photo-detail')}}">Photo-details</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link nav-link-2 {{ request()->routeIs('videos')? 'active':''  }}" href="{{route('videos')}}">Videos</a>
                </li>
                <li class="nav-item">
